...
void setup()
{
  ...
  */
  logfile.println("datetime,moist");
#if ECHO_TO_SERIAL
  Serial.println("datetime,moist");
#endif //ECHO_TO_SERIAL
...
void loop()
{
  ...
  moist = analogRead(0); //connect sensor to Analog 0
  Serial.println(moist); //print the value to serial port
  delay(3000);
